...
const _storyExpansions =
    <({String id, String lead, String intro, String action, String quote})>[
      (
        id: 'breath',
        lead: '숨을 고르고',
...
String _firstSentence(String text) =>
    text.split(RegExp(r'(?<=[.!?])\s+')).first.trim();
...
final storyDb = <StoryItem>[
  ...
  for (final seed in _storySeeds) ...[
    StoryItem(
      ...
      theme: seed.theme,
      title: seed.title,
      body: _firstSentences(seed.body, 2),
      quote: seed.quote,
    ...
    for (final expansion in _storyExpansions)
      StoryItem(
        ...
        body: '${_firstSentence(seed.body)} ${expansion.action}',

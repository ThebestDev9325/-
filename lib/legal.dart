...
5. 사용자의 권리
사용자는 설정에서 자신의 데이터를 삭제하거나 회원탈퇴를 요청할 수 있습니다. 동의 철회 및 개인정보 관련 문의는 출시 전 공개되는 운영자 문의 채널을 통해 접수할 수 있습니다.

6. 안전성 확보
참을인은 접근 권한 관리와 전송 구간 보호 등 개인정보 보호를 위한 조치를 적용합니다.

※ 이 문서는 현재 앱 기능에 맞춘 출시 준비 초안입니다. 운영자명, 문의처, 정확한 보유 기간과 국외 이전 사항은 출시 전 확정하여 고지합니다.''',
